...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Table ID="Table2" runat="server" HorizontalAlign="Center">
        <asp:TableRow runat="server">
            <asp:TableCell runat="server">
                <asp:Image ID="Image6" runat="server" Height="204px" ImageUrl="/Images/image1.jpg" Width="306px" />

            </asp:TableCell>
            <asp:TableCell runat="server">
                <asp:Image ID="Image1" runat="server" Height="204px" ImageUrl="/Images/image22v2.jpg" Width="306px" />
            </asp:TableCell>
            <asp:TableCell runat="server">
                <asp:Image ID="Image2" runat="server" Height="204px" ImageUrl="/Images/IMG_1276.JPG" Width="306px" />
            </asp:TableCell>
            <asp:TableCell runat="server">
                <asp:Image ID="Image3" runat="server" Height="204px" ImageUrl="/Images/image33.jpg" Width="306px" />
            </asp:TableCell>

            <asp:TableCell runat="server">
                <asp:Image ID="Image5" runat="server" Height="204px" ImageUrl="/Images/image11v2.jpg" Width="306px" />
            </asp:TableCell>
            <asp:TableCell runat="server">
                <asp:Image ID="Image4" runat="server" Height="204px" ImageUrl="/Images/image2.jpg" Width="306px" />
    ...
    <asp:Table ID="Table3" runat="server" HorizontalAlign="Center">
        ...
        <asp:TableRow runat="server">
            <asp:TableCell runat="server">   <img id="birdsEye" src="/Images/BirdsEye.JPG" alt="/Images/BirdsEyeAlt.JPG" style:"z-index:1" usemap="#Map"/>
            </asp:TableCell>
        </asp:TableRow>
    </asp:Table>
