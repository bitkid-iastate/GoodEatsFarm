...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Table ID="Table1" runat="server" HorizontalAlign="Center" Width="900px">
        <asp:TableRow runat="server">
            <asp:TableCell runat="server"><asp:Image ID="Image1" runat="server" Height="204px" ImageUrl="~/Images/Products/Johnagold2.JPG" Width="306px" /></asp:TableCell>
        ...
        <asp:TableRow runat="server">
            <asp:TableCell runat="server"><asp:Image ID="Image2" runat="server" Height="204px" ImageUrl="~/Images/Products/Liberty.JPG" Width="306px" /></asp:TableCell>
        ...
        <asp:TableRow runat="server">
            <asp:TableCell runat="server"><asp:Image ID="Image3" runat="server" Height="204px" ImageUrl="~/Images/Products/GoldDelicious.JPG" Width="306px" /></asp:TableCell>
        ...
        <asp:TableRow runat="server">
            <asp:TableCell runat="server"><asp:Image ID="Image4" runat="server" Height="204px" ImageUrl="~/Images/Products/Gravensteins.JPG" Width="306px" /></asp:TableCell>
        ...
        <asp:TableRow runat="server">
            <asp:TableCell runat="server"><asp:Image ID="Image5" runat="server" Height="204px" ImageUrl="~/Images/Products/Empire.JPG" Width="306px" /></asp:TableCell>
        ...
        <asp:TableRow runat="server">
            <asp:TableCell runat="server"><asp:Image ID="Image6" runat="server" Height="204px" ImageUrl="~/Images/Products/Fuji.JPG" Width="306px" /></asp:TableCell>
        ...
        <asp:TableRow runat="server">
            <asp:TableCell runat="server"><asp:Image ID="Image7" runat="server" Height="204px" ImageUrl="~/Images/Products/GrannySmith.JPG" Width="306px" /></asp:TableCell>
